...
import pycnf.convert as convert
...
class ConfigtypeTest(unittest.TestCase):
    ...
    def test_pycnf(self):
        ...
        self.assertEqual(json_config.get("default", "debug"), "{{debug}} {{debug2}}")
        ...
        self.assertEqual(ini_config.get("default", "debug"), "{{debug}} {{debug2}}")
        ...
        self.assertEqual(yaml_config.get("default", "debug"), "{{debug}} {{debug2}}")
        ...
        self.assertEqual(toml_config.get("default", "debug"), "{{debug}} {{debug2}}")
    ...
    def test_convert(self):
        ...
        os.mkdir(temp_dir)
        temp_file = "%s/write.test.json" % (temp_dir)
        self.assertEqual(convert.convert("tests/config.toml", temp_file, "json"), True)
